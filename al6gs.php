...
$query = "INSERT INTO dbuser (comments,rating)VALUES('$comments','$rating')";
...
<body>
  <nav class="navbar navbar-expand-md navbar-light bg-info">
    <div class="container">
    <a class="navbar-brand text-white" href="قائمة التفضيلات.html">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link text-white" href="قائمة التفضيلات.html">الرئيسية <span class="sr-only"></span></a>
      </li>
      <li class="nav-item">
        <a  class="nav-link text-white" href="سياسه.html" >السياسه</a>
      </li>
      ...
      <li> <a href="#" class="dropdown-item text-white"> معلومات الحساب</a>
      </li>
      <li> <a href="#" class="dropdown-item text-white"> المفضلات </a>
      </li>
  ...
  <form class="d-flex">
    ...
    <button type="submit" class="btn btn-outline-light"> ابحث</button>
  </form>
  </div>
  </nav>
...
$query= "SELECT * FROM dbuser order by rating DESC";
$result = mysqli_query($con, $query);
    ?>
    <form action="" method="post"><label> اكتب تعليقك</label><br>
       <textarea name="comments" rows="3" cols="35"> </textarea>
        <br> <lable><button type="submit">ارسل</button></lable>
          <div class="rating">
        ...
        <input type="radio" name="rating" value="★" id="1"><label for="1">☆</label>
            ...
            echo $row['comments']."<br><span style='font-size:30px; color:black;'>".$row['rating']."</span><hr>";
                                           }
                                    echo "</div>";
                                   mysqli_close($con);
                               ?>      
